...
- Safe on sealed soil; offline loss only if the home is **[[coordinates|found]]** (rare), never from neglect.

## Open questions

- Build depth, materials, structure types, buildable defences, grid vs. free-form, anything analogous to taming. Tracked in open-questions.md.
