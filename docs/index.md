...
- [[World Overview]] — premise, design thesis, the Gates & Builders, the mystery.
- [[Timeline]] — anchored on the Wake (year zero).
...
- [[world-types|World Types]] — planet-bases, hub worlds, Safe Core, Frontier (high-level).

### Events

- [[the-wake|The Wake]] — the network switching on; year zero; the mystery's inciting event.

## Systems

### Overview

- [[Systems Overview]] — the mechanics map; reach = exposure; the core loop (three scales).
