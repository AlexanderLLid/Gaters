# Builders' Truth — behind the curtain

**This is the designer's answer to the central mystery. It is parked: do NOT surface it to players until a payoff earns it.** In-game, the Builders stay unknown ([[the-builders|The Builders]]); only the system's _function_ is observable. This page records the candidate _purpose_ so we build consistently toward it.
